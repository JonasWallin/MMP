...
```
The random effect on the group level is much worse, compared to fitting Gaussian processes on two levels. The random effect on indivual level is basically equivalent to the Gaussian process.
```{r AIC, echo=FALSE}
