...
```
And examine how the variability changes over time on group and individual level, we can see that the fitted model has similar dynamics as the raw data, i.e. the variance of group effects increases over time, while
the variance of individual effects decreases over time.
```{r cov}
