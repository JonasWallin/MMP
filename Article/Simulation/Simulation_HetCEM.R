...
mypath <- "/Users/baurne/Documents/Consensus emergence/SimulationResults/HetCEM"
...
saveRDS(result_list, file = "HetCE_delta0.RData")
...
saveRDS(result_list, file = "HetCE_delta-0.03.RData")
...
saveRDS(result_list, file = "HetCE_delta-0.05.RData")
...
saveRDS(result_list, file = "HetCE_delta-0.08.RData")
