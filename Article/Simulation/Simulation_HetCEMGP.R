...
mypath <- "/Users/baurne/Documents/Consensus emergence/SimulationResults/HetCEM_GP"
...
saveRDS(result_list, file = "HetCEGP_delta0.RData")
...
saveRDS(result_list, file = "HetCEGP_delta-0.03.RData")
...
saveRDS(result_list, file = "HetCEGP_delta-0.05.RData")
...
saveRDS(result_list, file = "HetCEGP_delta-0.08.RData")
